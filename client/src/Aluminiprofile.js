...
const Aluminiprofile = () => {
    ...
    const pgHandler = e  =>{
        e.preventDefault();
        if(pg){
            axios.put(`http://localhost:5000/addpgA/${iprofile._id}`,{ pg:pg }).then(
    ...
    const expHandler = e  =>{
        e.preventDefault();
        if(experience){
            axios.put(`http://localhost:5000/addexpA/${iprofile._id}`,{ experience:experience }).then(
                response => alert(response.data)
            );
            setExperience("")
        }
    ...
    const projectHandler = e  =>{
        e.preventDefault();
        if(project){
            axios.put(`http://localhost:5000/addprojectA/${iprofile._id}`,{ project:project }).then(
                response => alert(response.data)
            );
            setProject("")
        }
    ...
    const bioHandler = e  =>{
        e.preventDefault();
        if(bio){
            axios.put(`http://localhost:5000/addbioA/${iprofile._id}`,{ bio:bio }).then(
                response => alert(response.data)
            );
            setBio("")
        }
    ...
    const quoteHandler = e  =>{
        e.preventDefault();
        if(quote){
        axios.put(`http://localhost:5000/addquoteA/${iprofile._id}`,{ quote:quote }).then(
            response => alert(response.data)
        );
        setQuote("")
        }
    ...
    const skillHandler = e  =>{
        e.preventDefault();
        if(skill){
        axios.put(`http://localhost:5000/addskillA/${iprofile._id}`,{ skill:skill }).then(
            response => alert(response.data)
        );
        setSkill("")
        }
    ...
    const jobHandler = e  =>{
        ...
        {
            axios.put(`http://localhost:5000/addjobA/${iprofile._id}`,jobdata).then(
                response => alert(response.data)
            );
    ...
    const mobileHandler = e  =>{
        e.preventDefault();
        if(mobile.length===10){
        axios.put(`http://localhost:5000/addmobileA/${iprofile._id}`,{ mobile:mobile }).then(
            response => alert(response.data)
        );
        setMobile("")
        }
    ...
    const githubHandler = e  =>{
        e.preventDefault();
        if(github.length>=20){
        axios.put(`http://localhost:5000/addgithubA/${iprofile._id}`,{ github:github }).then(
            response => alert(response.data)
        );
        setGithub("")
        }
    ...
    const linkedinHandler = e  =>{
        ...
        axios.put(`http://localhost:5000/addlinkedinA/${iprofile._id}`,{ linkedin:linkedin }).then(
            response => alert(response.data)
        );
        setLinkedin("")
        }
        ...
        <div>
            ...
            <div className="profile bg-light card " style={{"margin":"10px"}}>
                <center>
                        ...
                        {iprofile.github ? <div><b>Github : </b><a href={iprofile.github} target="_blank">{iprofile.github}</a>
                        <br />
                        ...
                        {iprofile.linkedin ? <div><b>Linkedin : </b><a href={iprofile.linkedin} target="_blank">{iprofile.linkedin}</a><br />
                                        <div>
