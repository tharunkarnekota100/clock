...
const Alumini = () => {
    ...
    const {fullname,collegeId,email,mobile,skill,branch,password,confirmpassword} = aluminidata
    ...
    return (
        <div>
            ...
            <section className="container">
                <h1 className="large " style={{"color":"orange","marginTop":"20px"}}>Aluminis Hub</h1>
                ...
                {a !== 0 ? <div>  
                    ...
                    <div>
                        ...
                        <form onSubmit={aluminisubmithandler}>
                            ...
                            <input type="text" className="form-control-lg m-1 border" value={collegeId} name="collegeId" placeholder="collegeId" onChange={aluminichangeHandler} /><br />
                            ...
                            <input type="text" className="form-control-lg m-1 border" value={password} name="password" placeholder="password" onChange={aluminichangeHandler} /><br />
                            <input type="text" className="form-control-lg m-1 border" value={confirmpassword} name="confirmpassword" placeholder="confirmpassword" onChange={aluminichangeHandler} /><br />
                    ...
                    <div>
                    <center>
                    <button className='btn btn-success' onClick={aHandler}>Add Alumini</button><br /><br />
                    </center>
                    </div>}
