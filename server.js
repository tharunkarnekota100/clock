...
const app = express();
mongoose.connect('mongodb+srv://tharunkarnekota:tharunkarnekota@cluster0.91wjg.mongodb.net/myFirstDatabase?retryWrites=true&w=majority').then(
...
app.post('/aluminiregister',async (req,res) =>{
    try{
        ...
        newUser.save();
        return res.status(200).send('Alumini Registered Successfully')
    }
    catch(err){
        console.log(err)
...
app.get('/allaluminis',async (req,res) =>{
    try{
...
app.get('/indprofilee/:id', async (req,res)=>{
    try{
...
app.get('/indprofilee2/:id', async (req,res)=>{
    try{
...
app.put('/updatemygithub/:id', async (req,res)=>{
    try{
...
app.put('/updatemylinkedin/:id', async (req,res)=>{
    try{
...
app.post('/adddescription',middleware,async(req,res)=>{
    try{
        ...
        return res.status(200).send('description saved successfully')
    }
    catch(err){
        console.log(err);
        return res.status(500).send('adddescription Server Error')
    }
})
...
app.put('/addgithubA/:id',async (req,res) =>{
    try{
        ...
        return res.status(200).send('Github Updated successfully')
    }
    catch(err){
        console.log(err);
...
app.put('/addlinkedinA/:id',async (req,res) =>{
    try{
        ...
        return res.status(200).send('linkedin Updated successfully')
    }
    catch(err){
        console.log(err);
...
app.put('/addpgA/:id',async (req,res) =>{
    try{
        const {pg} = req.body; 
        const updated = await aluminimodel.findByIdAndUpdate(req.params.id,{
        ...
        return res.status(200).send('Post Graduation updated successfully')
    }
    catch(err){
        console.log(err);
...
app.put('/addbioA/:id',async (req,res) =>{
    try{
        const {bio} = req.body; 
        const updated = await aluminimodel.findByIdAndUpdate(req.params.id,{
...
app.put('/addprojectA/:id',async (req,res) =>{
    try{
        const {project} = req.body; 
        const updated = await aluminimodel.findByIdAndUpdate(req.params.id,{
...
app.put('/addexpA/:id',async (req,res) =>{
    try{
...
app.put('/addskillA/:id',async (req,res) =>{
    try{
...
app.put('/addmobileA/:id',async (req,res) =>{
    try{
...
app.put('/addquoteA/:id',async (req,res) =>{
    try{
        const {quote} = req.body; 
        // const newquote = new aluminimodel({
        //     quote
        // })
        const updated = await aluminimodel.findByIdAndUpdate(req.params.id,{
...
app.put('/addjobA/:id',async (req,res) =>{
    try{
        ...
        return res.status(200).send('job company location Updated successfully')
    }
    catch(err){
        console.log(err);
